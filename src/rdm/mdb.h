 ...
 *
 * @param mdb A pointer to a message data block.
 * @param data A pointer to an array in which to store the decoded values.
 ...
 * 
 * @param mdb A pointer to a message data block.
 * @param data A pointer to an array which stores the values to encode.
 ...
 *
 * @param mdb A pointer to a message data block.
 * @param data A pointer to an array in which to store the decoded string.
 * @param num The number of elements in the array in which to store the decoded
 * string.
 ...
 *
 * @param mdb A pointer to a message data block.
 * @param data A pointer to an array which stores the encoded string.
 ...
 * 
 * @param mdb A pointer to a message data block.
 * @param data A pointer to a buffer which stores the decoded mute parameter,
 * typically an rdm_disc_mute_t.
 ...
 *
 * @param mdb A pointer to a message data block.
 * @param data A pointer to a buffer which stores the mute parameter to encode,
 * typically an rdm_disc_mute_t.
 ...
 *
 * @param mdb A pointer to a message data block.
 * @param data A pointer to a buffer which stores the decoded device info
 ...
 *
 * @param mdb A pointer to a message data block.
 * @param data A pointer to a buffer which stores the device info parameter to
 * encode, typically an rdm_device_info_t.
