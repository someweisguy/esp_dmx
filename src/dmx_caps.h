...
enum {
    ...
    DMX_READ_TIMEOUT_US = 1250000,
    DMX_READ_TIMEOUT_TICK = DMX_READ_TIMEOUT_US / 1000 / portTICK_PERIOD_MS
};
...
enum {
    ...
    DMX_WRITE_TIMEOUT_US = 1000000,
    DMX_WRITE_TIMEOUT_TICK = DMX_WRITE_TIMEOUT_US / 1000 / portTICK_PERIOD_MS
};
